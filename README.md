...
- [Семестр 3](#семестр-3)
    ...
    - [Урок 8](#урок-8)
- [Семестр 4](#семестр-4)
    - [Урок 1 - работа с git](#урок-1---работа-с-git)
    - [Урок 2](#урок-2-1)
    - [Урок 3 - контейнеры стандартной библиотеки](#урок-3---контейнеры-стандартной-библиотеки)
    - [Урок 4 - работа с хеш-таблицами(std::set)](#урок-4---работа-с-хеш-таблицамиstdset)
    - [Урок 7 - многопоточное программирование](#урок-7---многопоточное-программирование)
    - [Зачет - реализация многопоточной программы для поиска похожих предложений](#зачет---реализация-многопоточной-программы-для-поиска-похожих-предложений)
...
### Урок 2 :pig2:
- [Контрольные вопросы](https://github.com/ShmakovVladimir/Csnussnus/blob/main/lesson_2/questions.md)
- [Метод Гаусса](https://github.com/ShmakovVladimir/Csnussnus/blob/main/lesson_2/A.cpp)
- [Сортировка вставками](https://github.com/ShmakovVladimir/Csnussnus/blob/main/lesson_2/B.cpp)
...
### Урок 1 - работа с git :tv:

- [Основы работы с системой контроля версий](lesson_2_1/README.md)
...
### Урок 3 - контейнеры стандартной библиотеки :alien:

- [Анализ выделения памяти в vector](lesson_2_3/task1)
- [График по полученным данным](lesson_2_3/task1/experiment1.png)
- [Время сортировки различных структур данных](lesson_2_3/task2/)
- [График по полученным данным](lesson_2_3/task2/interpolation.png)

### Урок 4 - работа с хеш-таблицами(std::set) :exploding_head:

- [Время добавления данных в std::set](lesson_2_4/task1_part1/)
- [График по полученным данным](lesson_2_4/task1_part1/set_append.png)


### Урок 7 - многопоточное программирование :star_struck:
...
### Зачет - реализация многопоточной программы для поиска похожих предложений :fairy_man:

- [Код](Зачет/main.cpp)
- [Ноутбук для проведения тестов](Зачет/main.ipynb)
- [График зависимости времени работы программы от количества предложений](Зачет/main.png)
